        ...
        json.values.forEach((item) => {
          ...
          if (tab.startsWith('pa')) {
            row = {
              ...
              f3: item[6].length > 0 ? parseFloat(item[6]) : null,
              sensitivity: item[7].length > 0 ? parseFloat(item[7]) : null,
              power: item[8]?.length > 0 ? parseFloat(item[8]) : null,
              range: item[9] || "",
              dispersion: item[10] || "",
              specialty: item[11],
              height: item[12].length > 0 ? parseFloat(item[12]) : null,
              width: item[13].length > 0 ? parseFloat(item[13]) : null,
              depth: item[14].length > 0 ? parseFloat(item[14]) : null,
              url: item[15],
              image_url: item[16],
              score: item[17],
