        ...
        <table class="min-w-full w-full divide-y divide-gray-200">
          ...
          >
            <tr class="hover:bg-gray-50 " v-for="(item, index) in displayedItems" :key="index">
              ...
              <td
                class="px-1 py-2 whitespace-nowrap text-right text-sm font-normal"
              >
                <button
                  @click="editItem(item)"
        ...
        <div class="bg-white rounded-md max-w-2xl w-full p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span v-if="isNewEntry && formErrors.enclosure" class="text-red-500 text-sm">Enclosure is required</span>
            </div>
            <div>
              <label
                class="block text-sm font-medium text-gray-700 mb-1"
              ...
              <span v-if="isNewEntry && formErrors.range" class="text-red-500 text-sm">Range is required</span>
            </div>
            <div>
              <label
                class="block text-sm font-medium text-gray-700 mb-1"
              >
               ...
               <select
                ...
                >
                  ...
                  <option v-for="speciality in availableSpecialties"
                          :key="speciality"
                          :value="speciality">
                    {{ speciality }}
                  </option>
          ...
          <div class="mt-6 flex justify-end space-x-3 text-sm">
            ...
            <div class="flex items-center">
              <svg v-if="isSubmitting" aria-hidden="true" class="inline size-4 text-gray-200 animate-spin dark:text-gray-600 fill-white mr-2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
